...
class TargetCoder(object, metaclass=ABCMeta):
    ...
    def encode(self, targets):
        ...
        normalized_targets = self.target_normalizer(targets, list(self.lookup.keys()))
    ...
    def decode(self, encoded_targets):
        ...
        targets = [list(self.lookup.keys())[encoded_target]
